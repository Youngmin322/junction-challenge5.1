...
> [!danger] 수행·승인 경계
> 실험 A·C의 관측·채집·출동 수행 주체는 팀이 아니라 승인된 조사기관·현장 파트너다. 팀의 역할은 실험 사전등록, 입력·결과 수신, 기록과 비교에 한정한다. 착수는 [[34) 추가자료 Engage-Investigate 완료감사와 재수행#외부 접촉 사전 Gate]]와 사용자의 외부 연락 승인 완료 이후에만 가능하다.
...
| --- | --- | --- |
| 취수 운영조직이 어떤 행동을 위해 어느 정도 위치해상도·선행시간을 필요로 하는가? | 직접 사용자 조사 필요 | 위치정보가 실제 행동을 바꾸지 않으면 위치 서비스 중단 |
